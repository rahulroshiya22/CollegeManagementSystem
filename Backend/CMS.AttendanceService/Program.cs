...
builder.Services.AddScoped<IAttendanceDapperRepository, AttendanceDapperRepository>();
...
Log.Information("AttendanceService starting up...");
...
{
    Log.Fatal(ex, "AttendanceService terminated unexpectedly");
}
finally
{
    Log.CloseAndFlush();
