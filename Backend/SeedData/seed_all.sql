-- =====================================================
-- NeoVerse CMS — Master Seed Data Script
-- Run each section against the respective service DB
-- =====================================================

-- =====================================================
-- 1. STUDENT SERVICE DB  (Departments + Students)
-- =====================================================
USE [StudentServiceDb]; -- adjust DB name
GO

SET IDENTITY_INSERT [Departments] ON;
INSERT INTO [Departments] (DepartmentId, Name, Code, [Description], IsActive) VALUES
(1,'Computer Science','CS','Computer Science and Engineering',1),
(2,'Information Technology','IT','Information Technology',1),
(3,'Electronics','ECE','Electronics and Communication Engineering',1),
(4,'Mechanical','ME','Mechanical Engineering',1),
(5,'Civil','CE','Civil Engineering',1),
(6,'Electrical','EE','Electrical Engineering',1),
(7,'Mathematics','MATH','Applied Mathematics',1),
(8,'Physics','PHY','Applied Physics',1);
SET IDENTITY_INSERT [Departments] OFF;
GO

SET IDENTITY_INSERT [Students] ON;
INSERT INTO [Students] (StudentId,FirstName,LastName,Email,Phone,RollNumber,DateOfBirth,Gender,[Address],DepartmentId,AdmissionYear,[Status],CreatedAt) VALUES
...
-- =====================================================
-- 2. COURSE SERVICE DB  (Departments + Courses)
-- =====================================================
USE [CourseServiceDb];
GO

SET IDENTITY_INSERT [Departments] ON;
INSERT INTO [Departments] (DepartmentId, Name, Code, IsActive) VALUES
(1,'Computer Science','CS',1),(2,'Information Technology','IT',1),
(3,'Electronics','ECE',1),(4,'Mechanical','ME',1),
(5,'Civil','CE',1),(6,'Electrical','EE',1),
(7,'Mathematics','MATH',1),(8,'Physics','PHY',1);
SET IDENTITY_INSERT [Departments] OFF;
GO

SET IDENTITY_INSERT [Courses] ON;
INSERT INTO [Courses] (CourseId,CourseCode,CourseName,[Description],Credits,Semester,DepartmentId,IsActive,CreatedAt) VALUES
(1,'CS101','Data Structures','Fundamental data structures and algorithms',4,1,1,1,'2024-01-01'),
(2,'CS102','Object Oriented Programming','OOP concepts with C++ and Java',4,1,1,1,'2024-01-01'),
(3,'CS201','Database Management Systems','Relational databases and SQL',4,3,1,1,'2024-01-01'),
(4,'CS202','Operating Systems','Process management, memory, file systems',4,3,1,1,'2024-01-01'),
(5,'CS301','Computer Networks','Network protocols and architecture',3,5,1,1,'2024-01-01'),
(6,'CS302','Machine Learning','Supervised and unsupervised learning',4,5,1,1,'2024-01-01'),
(7,'IT101','Web Technologies','HTML, CSS, JavaScript, React',4,1,2,1,'2024-01-01'),
(8,'IT102','Software Engineering','SDLC, Agile, Design Patterns',3,1,2,1,'2024-01-01'),
(9,'IT201','Cloud Computing','AWS, Azure, Docker, Kubernetes',4,3,2,1,'2024-01-01'),
(10,'IT202','Cyber Security','Network security and cryptography',3,3,2,1,'2024-01-01'),
(11,'ECE101','Digital Electronics','Logic gates, combinational circuits',4,1,3,1,'2024-01-01'),
(12,'ECE102','Signals and Systems','Signal processing fundamentals',4,1,3,1,'2024-01-01'),
(13,'ECE201','Microprocessors','8085/8086 architecture and programming',4,3,3,1,'2024-01-01'),
(14,'ME101','Engineering Mechanics','Statics and dynamics',4,1,4,1,'2024-01-01'),
(15,'ME102','Thermodynamics','Laws of thermodynamics and applications',4,1,4,1,'2024-01-01'),
(16,'CE101','Surveying','Land surveying techniques',3,1,5,1,'2024-01-01'),
(17,'CE102','Structural Analysis','Analysis of beams, trusses, frames',4,1,5,1,'2024-01-01'),
(18,'EE101','Circuit Theory','Kirchhoffs laws, network theorems',4,1,6,1,'2024-01-01'),
(19,'MATH101','Linear Algebra','Matrices, vector spaces, eigenvalues',3,1,7,1,'2024-01-01'),
(20,'PHY101','Engineering Physics','Optics, quantum mechanics, solid state',3,1,8,1,'2024-01-01');
SET IDENTITY_INSERT [Courses] OFF;
GO

-- =====================================================
-- 3. ENROLLMENT SERVICE DB
-- =====================================================
USE [EnrollmentServiceDb];
GO

SET IDENTITY_INSERT [Enrollments] ON;
INSERT INTO [Enrollments] (EnrollmentId,StudentId,CourseId,EnrollmentDate,Semester,[Year],[Status],Grade) VALUES
...
INSERT INTO [Fees] (FeeId,StudentId,Amount,[Description],[Status],DueDate,PaidDate,CreatedAt) VALUES
...
-- =====================================================
-- 5. ACADEMIC SERVICE DB (TimeSlots, Grades, Notices)
-- =====================================================
USE [AcademicServiceDb];
GO
...
(1,1,1,'Monday','09:00','10:00','CS-301',1,2024,1,'2024-07-01'),
(2,1,1,'Wednesday','09:00','10:00','CS-301',1,2024,1,'2024-07-01'),
(3,2,1,'Monday','10:15','11:15','CS-302',1,2024,1,'2024-07-01'),
(4,2,1,'Thursday','10:15','11:15','CS-302',1,2024,1,'2024-07-01'),
(5,3,2,'Tuesday','09:00','10:00','CS-Lab1',3,2024,1,'2024-07-01'),
(6,3,2,'Friday','09:00','10:00','CS-Lab1',3,2024,1,'2024-07-01'),
(7,4,1,'Tuesday','11:30','12:30','CS-303',3,2024,1,'2024-07-01'),
(8,5,2,'Wednesday','11:30','12:30','CS-304',5,2024,1,'2024-07-01'),
(9,6,2,'Thursday','14:00','15:30','AI-Lab',5,2024,1,'2024-07-01'),
(10,7,3,'Monday','09:00','10:00','IT-201',1,2024,1,'2024-07-01'),
(11,7,3,'Wednesday','09:00','10:00','IT-201',1,2024,1,'2024-07-01'),
(12,8,3,'Tuesday','10:15','11:15','IT-202',1,2024,1,'2024-07-01'),
(13,9,4,'Monday','11:30','12:30','IT-Lab1',3,2024,1,'2024-07-01'),
(14,9,4,'Thursday','11:30','12:30','IT-Lab1',3,2024,1,'2024-07-01'),
(15,10,4,'Friday','10:15','11:15','IT-203',3,2024,1,'2024-07-01'),
(16,11,5,'Monday','14:00','15:00','ECE-101',1,2024,1,'2024-07-01'),
(17,11,5,'Wednesday','14:00','15:00','ECE-101',1,2024,1,'2024-07-01'),
(18,12,5,'Tuesday','14:00','15:00','ECE-Lab',1,2024,1,'2024-07-01'),
(19,13,5,'Thursday','09:00','10:00','ECE-201',3,2024,1,'2024-07-01'),
(20,14,6,'Monday','09:00','10:00','ME-101',1,2024,1,'2024-07-01'),
(21,14,6,'Wednesday','10:15','11:15','ME-101',1,2024,1,'2024-07-01'),
(22,15,6,'Tuesday','09:00','10:00','ME-Lab',1,2024,1,'2024-07-01'),
(23,16,7,'Thursday','14:00','15:00','CE-101',1,2024,1,'2024-07-01'),
(24,17,7,'Friday','14:00','15:30','CE-Lab',1,2024,1,'2024-07-01'),
(25,18,8,'Monday','10:15','11:15','EE-101',1,2024,1,'2024-07-01'),
(26,18,8,'Wednesday','10:15','11:15','EE-101',1,2024,1,'2024-07-01'),
(27,19,9,'Tuesday','11:30','12:30','MATH-101',1,2024,1,'2024-07-01'),
(28,19,9,'Thursday','11:30','12:30','MATH-101',1,2024,1,'2024-07-01'),
(29,20,10,'Friday','09:00','10:00','PHY-101',1,2024,1,'2024-07-01'),
(30,20,10,'Wednesday','14:00','15:00','PHY-Lab',1,2024,1,'2024-07-01');
SET IDENTITY_INSERT [TimeSlots] OFF;
GO

SET IDENTITY_INSERT [Grades] ON;
INSERT INTO [Grades] (GradeId,StudentId,CourseId,Marks,GradeLetter,Semester,[Year],Remarks,CreatedAt) VALUES
...
(1,'Welcome to Semester 2 — 2025','Dear students, welcome back! Classes begin on Jan 20.','Academic',NULL,1,'Admin',1,'2025-01-10'),
(2,'Mid-Semester Exam Schedule','Mid-semester exams will be held from March 10-20. Please check the timetable.','Exam','Student',1,'Admin',1,'2025-02-15'),
(3,'Annual Sports Day','Annual sports day on Feb 28. All are welcome to participate!','Event',NULL,1,'Admin',1,'2025-02-01'),
(4,'Library Extended Hours','Library will remain open until 10 PM during exam season.','General',NULL,1,'Admin',1,'2025-02-20'),
(5,'Faculty Meeting','Monthly faculty meeting on March 1 at 3 PM in Conference Hall.','General','Teacher',1,'Admin',1,'2025-02-25'),
(6,'Scholarship Applications Open','Merit scholarship applications for 2025 are now open. Deadline: March 15.','Academic','Student',1,'Admin',1,'2025-02-10'),
(7,'Hackathon 2025','24-hour hackathon on March 25. Register at the CS department.','Event','Student',1,'Admin',1,'2025-03-01'),
(8,'New Lab Equipment','New IoT lab equipment has arrived. Training sessions start March 5.','Academic','Teacher',1,'Admin',1,'2025-02-28'),
(9,'Holiday Notice — Holi','College will remain closed on March 14 for Holi.','General',NULL,1,'Admin',1,'2025-03-05'),
(10,'Placement Drive — TCS','TCS campus placement drive on April 5. Eligibility: 7+ CGPA.','Academic','Student',1,'Admin',1,'2025-03-10');
SET IDENTITY_INSERT [Notices] OFF;
GO

-- =====================================================
-- 6. ATTENDANCE SERVICE DB (sample attendance records)
-- =====================================================
USE [AttendanceServiceDb];
GO

-- Generate attendance for Feb 2025 (Mon-Fri) for students 1-10 in Course 1
SET IDENTITY_INSERT [Attendances] ON;
DECLARE @id INT = 1;
INSERT INTO [Attendances] (AttendanceId,StudentId,CourseId,[Date],IsPresent,Remarks) VALUES
(1,1,1,'2025-02-03',1,NULL),(2,2,1,'2025-02-03',1,NULL),(3,3,1,'2025-02-03',1,NULL),
(4,4,1,'2025-02-03',0,'Sick leave'),(5,5,1,'2025-02-03',1,NULL),(6,6,1,'2025-02-03',1,NULL),
(7,7,1,'2025-02-03',1,NULL),(8,1,1,'2025-02-05',1,NULL),(9,2,1,'2025-02-05',1,NULL),
(10,3,1,'2025-02-05',0,'Family emergency'),(11,4,1,'2025-02-05',1,NULL),(12,5,1,'2025-02-05',1,NULL),
(13,6,1,'2025-02-05',1,NULL),(14,7,1,'2025-02-05',0,NULL),(15,1,1,'2025-02-10',1,NULL),
(16,2,1,'2025-02-10',0,NULL),(17,3,1,'2025-02-10',1,NULL),(18,4,1,'2025-02-10',1,NULL),
(19,5,1,'2025-02-10',1,NULL),(20,6,1,'2025-02-10',1,NULL),(21,7,1,'2025-02-10',1,NULL),
(22,1,1,'2025-02-12',1,NULL),(23,2,1,'2025-02-12',1,NULL),(24,3,1,'2025-02-12',1,NULL),
(25,4,1,'2025-02-12',1,NULL),(26,5,1,'2025-02-12',0,'Late'),(27,6,1,'2025-02-12',1,NULL),
(28,7,1,'2025-02-12',1,NULL),(29,8,7,'2025-02-03',1,NULL),(30,9,7,'2025-02-03',1,NULL),
(31,10,7,'2025-02-03',0,NULL),(32,11,7,'2025-02-03',1,NULL),(33,12,7,'2025-02-03',1,NULL),
(34,13,7,'2025-02-03',1,NULL),(35,8,7,'2025-02-05',1,NULL),(36,9,7,'2025-02-05',0,NULL),
(37,10,7,'2025-02-05',1,NULL),(38,11,7,'2025-02-05',1,NULL),(39,12,7,'2025-02-05',1,NULL),
(40,13,7,'2025-02-05',1,NULL),(41,14,11,'2025-02-03',1,NULL),(42,15,11,'2025-02-03',1,NULL),
(43,16,11,'2025-02-03',0,NULL),(44,17,11,'2025-02-03',1,NULL),(45,18,11,'2025-02-03',1,NULL),
(46,14,11,'2025-02-05',1,NULL),(47,15,11,'2025-02-05',1,NULL),(48,16,11,'2025-02-05',1,NULL),
(49,17,11,'2025-02-05',0,'Medical'),(50,18,11,'2025-02-05',1,NULL);
